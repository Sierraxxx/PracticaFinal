...
//   2. Conteo manual de allocaciones del algoritmo — memoria auxiliar exacta
//
// La medición #2 es más precisa para comparar algoritmos porque excluye
...
// Permite medir exactamente cuánta memoria auxiliar usa un algoritmo
...
struct MemoryProbe {
    size_t rss_before  = 0;
    size_t rss_peak    = 0;
    size_t aux_estimate = 0;  // estimación heurística por algoritmo + N + U
...
// Heurísticas de memoria auxiliar por algoritmo (conocida del análisis Big O)
